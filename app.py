...
# Note: All preprocessing (mask generation, chart analysis) is handled by
# enhanced_preprocessing.py via /api/trigger-preprocessing/<task_id>.
# Mask generation uses the HuggingFace Space: Aniketg6/medsam-inference
